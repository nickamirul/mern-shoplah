...
const Profile = () => {
  ...
  return (
    <div className="relative bg-gray-50 min-h-screen pt-5">
      <h1 className="text-3xl font-semibold text-center my-5 text-gray-800">Profile</h1>
      <form
      ...
      >
        ...
        <button
          disabled={loading}
          className="bg-black text-white p-3 rounded-lg uppercase hover:bg-gray-800 disabled:opacity-50"
        >
